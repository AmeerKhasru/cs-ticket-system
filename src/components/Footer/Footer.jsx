...
const Footer = () => {
    return (
        ...
        <footer className="max-w-[1200px] mx-auto bg-black border-t border-slate-800 mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
                    ...
                    <div className="col-span-1 md:col-span-1 px-4">
                        <div className="flex items-center   gap-2 mb-4">
                            <div className="h-8 w-8 bg-[#422AD5] rounded-lg flex items-center justify-center text-white font-black text-xl italic">T</div>
                            {/* Changed text-slate-800 to text-white */}
                            <span className="text-xl font-black tracking-tighter text-white italic">CS-Ticket System</span>
                        </div>
